        ...
        <main onMouseMove={(e) => { manageMouseMove(e) }} className={styles.main}>
            ...
            <div className={styles.title}>
                ...
                <Button onClick={() => {
                    ...
                    router.push("/explore")
                }} className="w-1/3 justify-center bg-spotify-green text-stone-100 rounded-xl mx-auto my-4 flex hover:bg-slate-300  -top-2 transition delay-7000 duration-800 ease-in-out">
                    Explore
                </Button>
