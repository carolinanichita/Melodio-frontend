  ...
  return (
    <section
      ...
      <div className="container mx-auto px-11 text-center py-14">
        ...
        <Button onClick={() => {
          router.push("/explore")
        }} variant={"outline"} className="w-40 shadow py-4 hover:text-gray-700 font-semibold justify-center text-spotify-green rounded-xl mx-auto my-8 flex hover:bg-slate-300   transition delay-100 duration-300 ease-in-out">
          Explore
        </Button>
